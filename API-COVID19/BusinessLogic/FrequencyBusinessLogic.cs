            ...
            if (Date.HasValue) 
            {
                ...
                switch (TypeFrecuency)
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        DataFrecuency = DataFrecuency.Where(t => t.DateReport.Date.Year >= newDate.Year && t.DateReport.Date.Year <= newDate.Year && t.DateReport.Month >= newDate.Month && t.DateReport.Month <= newDate.Month);
                        break;
                    case 3:
